...
curl -u "$credentials" "$host/api/v1/namespaces/_/actions/$action" -XPUT -d '{"namespace":"_","name":"test","exec":{"kind":"nodejs:6","code":"function main(){return {};}"}}' -H "Content-Type: application/json"
